		...
		<div className='container'>
			...
			<main className='hero-blue mb-3'>
				...
				<p className='p-base text-blue-700'>
					...
					Product Designer durante más de un año. Aunque mi objetivo
					principal fue ayudar a la empresa a crear soluciones
					amigables para los consumidores (B2C), también
				...
				<div className='section-block-inside'>
					<div>
						...
						<p className='p-base '>
							...
							meses. El desarrollo tomó de 3 a 4 meses. El
							producto fue lanzado aproximadamente en 6
							aproximadamente.
						</p>
					</div>
					<div>
				...
				<div className='section-block-inside'>
					<div>
						...
						<p className='p-base '>
							...
							cursos a otras empresas{' '}
							<span className='b-base'>(B2B)</span>, sin embargo
							estas ventas{' '}
							<span className='b-base'>representaban un 2%</span>{' '}
							del macro de ventas de la empresa. El objetivo era
							claro: aumentar las ventas corporativas. Sin
							embargo, nacieron algunas preguntas: ¿Qué necesitan
							las empresas para confiar la capacitación de sus
							empleado en EDteam? ¿Qué valor agregado necesitaban
							para comprar mas cursos y capacitar a sus empleados?
							¿Les basta con “saber” 🤔 que sus empleados están
							tomando cursos para capacitarse? ¿Les importa
					...
					<div>
						...
						<p className='p-base mb-3 '>
							...
							obvio teníamos algunas ideas, pero eran supuestos.
							Por ellos ejecuté{' '}
							<span className='b-base'>
								una encuesta con 21 empresas
							</span>{' '}
							, ¿y por qué ese número mágico? Porque algunas de
							esas empresas que ya nos habían comprado cursos y
							otras al menos estaban interesadas. El propósito era
							validar la necesidad que suponíamos existía.
						</p>
				...
				<div className='section-block-inside'>
					<div>
						...
						<ul className='p-base space-y-2'>
							<li className='flex'>
								<span className='p-base pr-4'>🔎</span>
								<span>
									<span className='b-base'>Un 35.2%</span> de
									las empresas encuestadas manifestó que es
									importante tener una forma de registrar el
									avance de estudios de los empleados.
								</span>
							</li>
							<li className='flex'>
								<span className='p-base pr-4'>🔎</span>
							...
							<li className='flex'>
								<span className='p-base pr-4'>🔎</span>
								<span>
									<span className='b-base'>Al 21.4%</span> le
									gustaría necesitan tener métricas sobre el
									progreso de avance de estudios.
								</span>
							</li>
							<li className='flex'>
								<span className='p-base pr-4'>🔎</span>
							...
							<li className='flex'>
								<span className='p-base pr-4'>🔎</span>
								<span>
									Generación de informes y métricas: para las
									empresas es importante{' '}
									<span className='b-base'>
										obtener informes y métricas detallados
										sobre el progreso de los empleados
									</span>
									, las calificaciones obtenidas, el tiempo
									dedicado a los cursos y la tasa de
					...
					<div className='hero-mini-purple mb-0'>
						...
						<p className='p-base text-purple-700'>
							...
							<span className='b-base text-purple-800'>
								{' '}
								el objetivo del producto no eran las empresas
								como tal
							</span>
							, sino las personas que administrarían el producto
							para la capacitación del personal. Las empresas
							podían comprar N cantidad de cursos,{' '}
							<span className='b-base text-purple-800'>
								pero las personas a cargo de el seguimiento eran
								los que necesitaban una forma de gestionar
							</span>{' '}
							la capacitación de los empleados. Estábamos
							equivocados en el enfoque lo importante son las
							personas y no la cantidad de ventas, obvio sí que
							importa la cantidad de ventas 😆, pero para obtener
							mejores resultados en la ventas , debíamos
					...
					<div>
						...
						<p className='p-base'>
							...
							necesitaba. Sin embargo, con esa información sí{' '}
				...
				<div className='section-block-inside'>
					<div>
						...
						<p className='p-base'>
							...
							Netflix, Spotify o Dropbox, entre otras, tienen un
							sistema de plan para grupos. Lo que ya estaban
							haciendo otras industrias nos sirvión para darnos
							una idea de la dirección visual en las
							funcionalidades que necesitábamos para nuestro
							producto.
						</p>
					</div>
				</div>
				...
				<div className='section-block-inside'>
					<div>
						...
						<p className='p-base mb-3 '>
							...
							lanzar las ideas primero a mano, así puedo esbozar
							de forma rápida las ideas y compartirlas con el
							equipo.
						</p>
					</div>
				</div>
				...
				<div className='section-block-inside'>
					<div>
						...
						<p className='p-base mb-3 '>
							...
							iterar. Abajo muestro la prueba que salió mal, muy
							mal, solo un 6% de usuarios entendieron el flujo.{' '}
							<span className='b-base text-gray-800'>
								Hicimos nuevos wireframes e hicimos otro test de
								usabilidad
							</span>{' '}
							, el segundo, no fue un éxito total, pero para un
							MVP del producto los directivos estuvieron conformes
							con que un{' '}
							<span className='b-base text-gray-800'>
								67% de usuarios
							</span>{' '}
							entendieran el flujo, y con eso pasamos a la etapa
			...
			<section className='mb-32 col-span-full'>
				...
				/>
				<p className='i-base text-center text-gray-600'>
					Capturas los test de usabilidad: A la izquierda, una prueba
					que falló en todo. A la derecha, una iteración que tuvo
					mejores resultados.
				</p>
			</section>
			<Divider className='divider-red'></Divider>
						...
						<ul className='p-base space-y-2'>
							<li className='flex'>
								...
								<span>
									...
									pestaña Dashboard),{' '}
									<span className='b-base text-gray-800'>
										para ellos era necesaria otra sección en
										el menú
									</span>{' '}
									que contenga al total de las personas que
									actualmente son parte de mi empresa, como lo
									que ya no son parte. Esta sección del menú
									<span className='b-base text-gray-800'>
										{' '}
										se debería llamar Mi equipo.
									</span>{' '}
									No estuve de acuerdo con esa decisión, pero
									no hubo oportunidad de negociarla así que
									cedí, uno debe aprender a ceder a los
									tomadores decisiones, y entender que muchas
									veces tienen sus razones.{' '}
								</span>
							</li>
							<li className='flex'>
								<span className='p-base pr-4'>⛳</span>
								<span>
									Por otro lado, en el modal, en la sección de
									Agregar más licencias,{' '}
									<span className='b-base text-gray-800'>
										ya no se tendría una funcionalidad de
										compra desde el modal,
									</span>{' '}
							...
							<li className='flex'>
								...
								<span>
									...
									que adquiera el plan de empresas en lugar
									del logo de EDteam, así se sentirían mejor
									identificados con su interfaz.
								</span>
							</li>
						</ul>
					</div>
						...
						<ul className='p-base space-y-2'>
							...
							<li className='flex'>
								...
								<span>
									...
									que ya eran clientes de EDteam manifestó que
									estaban satisfechos con el nuevo producto
									(aunque tenían feedback que darnos).
								</span>
							</li>
						</ul>
					</div>
